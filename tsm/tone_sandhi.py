...
from tsm.symbols import TSM_IPA_RHYME_TO_PHONE
from 臺灣言語工具.基本物件.公用變數 import 分字符號, 分詞符號, 標點符號

def 台灣話口語講法(句物件, apply_tone_sandhi=True):
